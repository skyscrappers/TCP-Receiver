...
uint64_t unwrap(WrappingInt32 n, WrappingInt32 isn, uint64_t checkpoint) {
    ...
    uint32_t unwrapped_no = static_cast<int64_t>(n.raw_value()) - static_cast<int64_t>(isn.raw_value());
    uint64_t abs_sequenceNo; 
    uint64_t shiftby32 = 1UL << 32;
    uint64_t shiftby31 = 1UL << 31;
    uint64_t k = checkpoint / shiftby32;
